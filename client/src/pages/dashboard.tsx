...
export default function Dashboard() {
    ...
    switch (key) {
      case "leaveTime":
        return (
          <>
            {showLeaveTimeWidget && (
              <motion.div variants={stagger.item} key="leaveTimeWidget">
            ...
            {showLeaveTimePrompt && (
              <motion.div variants={stagger.item} key="leaveTimePrompt">
      ...
      case "schedule":
        return (
          <motion.div variants={stagger.item} key="schedule">
      ...
      case "todayEvents":
        ...
        return (
          <motion.div variants={stagger.item} key="todayEvents">
      ...
      case "quickActions":
        return (
          <motion.div variants={stagger.item} key="quickActions">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-display font-bold flex items-center gap-2">
      ...
      case "upcomingBills":
        ...
        return (
          <motion.div variants={stagger.item} key="upcomingBills">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-display font-bold flex items-center gap-2">
      ...
      case "savings":
        ...
        return (
          <motion.div variants={stagger.item} key="savings">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-display font-bold flex items-center gap-2">
      ...
      case "tomorrow":
        ...
        return (
          <motion.div variants={stagger.item} key="tomorrow">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-display font-bold flex items-center gap-2">
  ...
  return (
    ...
    >
      ...
      {enabledWidgets.map(w => <div key={w.key}>{renderWidget(w.key)}</div>)}
